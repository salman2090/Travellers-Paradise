        ...
        <div className="bg-footer p-3">
            <div className="p-5 footer-container ">
                <div >
                    ...
                    <p className="text-light fs-6"><span>{emailIcon}</span> {' '}&emsp; t.paradise@gmail.com</p>
                </div>
                <div >
            ...
            <p className="footer-text fs-5">© 2021 Traveller's Paradise. All Right Reserved.</p>
        </div>
    );
};
